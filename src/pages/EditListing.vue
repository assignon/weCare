<template>
  <div class="page-container pb-24">
    ...
    <div class="p-4">
      <div v-if="!loading && listingStatus === 'sold'" class="bg-red-50 rounded-2xl p-4 mb-4">
        <p class="text-red-800 text-sm font-semibold">{{ $t('listings.cannot_edit_sold') }}</p>
      </div>
    ...
    <!-- Fixed Submit Button -->
    <div v-if="listingStatus !== 'sold'" class="action-bar">
      <button
        type="button"
        @click="submit"

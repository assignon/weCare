          ...
          <v-card class="text-center pa-8" elevation="0" variant="text">
            ...
            >
              ...
              <div class="d-flex justify-space-between align-center mb-2">
                ...
                <span class="text-subtitle-2 font-weight-bold">${{ orderDetails.total_amount || '0.00' }}</span>
              </div>
              
              <div class="d-flex justify-space-between align-center">
                <span class="text-subtitle-2 font-weight-medium">Payment Method:</span>
                <span class="text-subtitle-2 font-weight-bold text-capitalize">{{ orderDetails.payment_method || 'N/A' }}</span>
              </div>
            </v-card>
